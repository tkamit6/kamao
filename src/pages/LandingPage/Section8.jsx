...
const Section8 = () => {
  return (
    <section className='section2 container mx-auto md:py-16 max-w-7xl wrap '>
        <h1 className='text-center font-bold md:text-5xl text-[1.75rem] font-head md:mb-16 mb-8 text-[#3D3E3E]'>Our <span className='text-[#E78353]  font-head'> Client </span> </h1>
