...
const Section2 = () => {
  return (
    <section className='section2 container mx-auto md:py-16 max-w-7xl wrap '>
        <h1 className='text-center font-bold md:text-5xl text-[1.75rem] font-head md:mb-16 mb-8 text-[#3D3E3E]'>We are <span className='text-[#E78353]'> Partnered </span> with</h1>
