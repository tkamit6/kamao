    ...
    return (
        ...
        <section className='section4 container mx-auto md:py-16 md:ps-10 wrap max-w-7xl bg-white'>
            <div className='stick-parallax'>
                <h1 className='text-center relative font-bold md:text-5xl text-[1.75rem] font-head md:mb-16 mb-12 text-[#3D3E3E]'>How it  <span className='text-[#E78353]'> Works? </span></h1>
