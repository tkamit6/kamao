...
import aboutPerson from '../../images/about-us/About-person.webp'

export default function Section4() {
    return (
        <section className='about-founder container mx-auto md:my-8 md:pt-16 max-w-7xl py-0 wrap '>
            <div className='grid md:grid-cols-12 items-center md:mx-[102px] mx-3 md:py-0 py-6 gap-x-12 '>
                <div className="col-span-6">
                    ...
                    <img src={aboutPerson} alt="img" className='md:hidden block mb-6' />
