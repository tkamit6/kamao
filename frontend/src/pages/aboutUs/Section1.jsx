    ...
    return (
        <section className='container mx-auto bg-[#FFF5EF] md:mb-8 md:mt-2 py-0 max-w-7xl wrap '>
            <div className='text-center md:pt-16 mt-6 relative'>
                ...
                <div className="absolute bg-[#F1B598] md:w-24 md:h-24 w-6 h-6 rounded-full md:right-[22%] right-[15%] "></div>
                ...
                <img src={banner} alt="img" className='md:w-[880px] w-[343px] mx-auto'  />
            </div>
        </section>
    )
}
