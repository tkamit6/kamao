        ...
        <section className='business-section9 container mx-auto md:py-16 max-w-7xl wrap '>
            <div className="grid md:grid-cols-4 py-5 md:px-[102px]">
                ...
                <div className='md:mb-12 mb-auto'>
                    ...
                    <img src={mobile} alt="mobile" className='block md:hidden mx-auto -mt-12' loading='lazy' />
                </div>
                    <ul className='flex flex-row md:mt-0 -mt-12 flex-wrap md:gap-x-10 md:gap-y-6 md:gap-0 gap-3 md:justify-start justify-center'>
