...
export default function Section1() {
    return (
        <section className='teamLeaderSection1 container mx-auto md:h-[50rem] h-[33rem] md:mb-8 md:mt-0 py-0 max-w-7xl wrap '>
            <div className='text-center md:pt-16 '>
                ...
                <Link to='#' className='text-base font-bold py-2 px-4 text-[#FA6F2C] border border-[#FA6F2C] rounded-full' >Enroll Now</Link>
            </div>
        </section>
    )
}
