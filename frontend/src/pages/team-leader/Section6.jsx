...
export default function Section6() {
    ...
    const finalformSubmit = async (e) => {
        ...
        try {
            setloading(true)
            await axios.post(`${apiUrl}/sendmail`, formData)
                            ...
                            formStep === 1 ? (
                                ...
                                <form onSubmit={finalformSubmit} className='gap-5'>
                                    ...
                                    <div className='flex space-x-4'>
                                        ...
                                        <button type='submit' disabled={loading} className='bg-[#FA6F2C] text-white gap-x-3 mt-6 flex items-center rounded-3xl py-2 px-9 me-2 relative border border-[#FA6F2C] font-bold cursor-pointer disabled:bg-[#d8cac3]'> {loading ? (<img src={loadingSVG} alt='loading' className='h-6 w-6' />) : 'Submit'}  </button>
                                    </div>
                                </form>
                            )
                        }
